...
namespace {
  V2Device::Info   Info{V2DeviceInfo("com.versioduo.axis", 8, "versioduo:samd:axis")};
  ...
  public:
    Device() : V2Device() {
      ...
      help.configuration   = "# Setup\n"
                             "The device can be mounted at any orientation or angle, the reference frame / axes can be aligned "
                             "to the current posion and stored in the device. This sequence identifies the Y axis (the axis of "
                             "rotation between the button clicks) and the Z axis (the gravity at the second step):\n"
                             "• The device, or the body it is mounted on, points upwards / to the sky. A double-click of the the "
                             "button, the LED turns green.\n"
                             "• The device points forward, the zero position. A single click, the LED turns orange. The axes of "
                             "the sensor are now aligned and the rotation reset to zero.\n"
                             ...
                             "Holding the device button down, suppresses all Control Change messages. The CC numbers can be "
                             "configured in the Setting section. Pressing the blue button there, sends this single CC message; "
                             "it can be used to map the CC in the Audio Workstation.";
    }
